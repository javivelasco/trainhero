...
(function() {
if (dwr.engine._getObject("loginManager") == undefined) {
var p;
...
p.getLogin = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'loginManager', 'getLogin', arguments);
};
...
p.validaHistorialContraseñas = function(p0, callback) {
return dwr.engine._execute(p._path, 'loginManager', 'validaHistorialContraseñas', arguments);
};

dwr.engine._setObject("loginManager", p);
}
})();
